...
public class Usuarios {
    ...
    private ArrayList<Cupones> cupons = new ArrayList<>();

    public Usuarios() {
    }

    public Usuarios(String nombre, String email, int numeroTelefono, String pass) {
        this.nombre = nombre;
        this.email = email;
    ...
    public Usuarios(String nombre, String email, int numeroTelefono, String pass, ArrayList<Cupones> cupons) {
        this.nombre = nombre;
        this.email = email;
        this.numeroTelefono = numeroTelefono;
        this.pass = pass;
