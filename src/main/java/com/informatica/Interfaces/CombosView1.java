 ...
 * @author Temporal
 */
public class CombosView1 extends javax.swing.JFrame {
    ...
    public CombosView1() {
       setUndecorated(true);
        ...
        setImageLabel(jLabel3, "src/main/resources/ComboPicante.jpg");
        setImageLabel(jLabel5, "src/main/resources/ComboTenders.jpeg");
        setImageLabel(jLabel6, "src/main/resources/ComboFamClas.png");
        setImageLabel(jLabel7, "src/main/resources/ComboFamPic.jpg");
    }
    ...
    private void initComponents() {
        ...
        jPanelPicantePollo.add(jh2_4, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 0, -1, 50));
        ...
        jLabelPollo4.setText("Familiar Clásico ");
        jLabelPollo4.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        jPanelPicantePollo.add(jLabelPollo4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, 220, 20));
        ...
        jLabelPollo5.setText("Familiar Picante");
        jLabelPollo5.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        jPanelAlitas.add(jLabelPollo5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, 210, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CombosView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CombosView1().setVisible(true);
            }
        });
    }
